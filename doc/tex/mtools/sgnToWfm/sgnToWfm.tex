...
%  [ data, symbolPeriod, samplingPeriod, type, numberOfSymbols,samplingRate  \] = sgnToWfm(fname_sgn);
  
%Inputs
%  fname_sgn - Input filename of the signal you want to convert, signal type: \textbf{Type}: Real signal (ContinuousTimeContinuousAmplitudeReal)
%
% Outputs
